...
const IrCode* const NApowerCodes[] PROGMEM = {
  ...
  &code_na131Code,
  &code_na132Code,
  &code_na133Code/*, // Sorry, had to take these out
  &code_na134Code,   // so this will fit on an ATtiny84
  &code_na135Code,
  &code_na136Code,*/
};
...
const IrCode* const EUpowerCodes[] PROGMEM = {
  ...
  &code_eu135Code,
  &code_eu136Code,
  &code_eu137Code/*,  // Sorry, had to take these out
  &code_eu138Code,    // so this will fit on an ATtiny84
  &code_eu139Code,*/  
};
#endif
